    ...
    <div class="col-lg-12">
        <div class="ibox ">
            ...
            <div class="ibox-content">
                <a class="btn btn-primary btn-lg pull-right mb-2" href="<?php echo base_url(); ?>admin/booking/create">Create Booking</a>
                <br />
...
<script type="text/javascript">
    ...
    var path = "<?php echo base_url(); ?>admin/booking/get_data"; //set the path to send request
    function getAdapter() {
        var source = {
            datatype: "json",
            datafields: [
    ...
    $(document).ready(function () {
        ...
        $("#" + gridID).jqxGrid({
            ...
            columns: [
                ...
                {text: 'Token Number', datafield: 'token_number',  filtertype: 'textbox', filtercondition: 'contains'},
                {text: 'Total Price', datafield: 'total_price',  filtertype: 'textbox', filtercondition: 'contains'},
                {text: 'Total Instalment', datafield: 'total_instalments', filtertype: 'textbox', cellsalign: 'center',filtercondition: 'contains',width: 100},

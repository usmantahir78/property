...
<!--            <div class="ibox-content">
                <a data-toggle="modal" class="btn btn-primary btn-lg pull-right mb-2" href="#modal-form">Create Booking</a>
                <br />-->
...
<script type="text/javascript">
    ...
    var path = "<?php echo base_url(); ?>admin/property/get_data"; //set the path to send request
    function getAdapter() {
        var source = {
            datatype: "json",
            datafields: [
                ...
                {name: 'property_size'},
                {name: 'property_per_marla'},
                {name: 'property_total_price'},
                {name: 'property_date_created'},
                {name: 'property_status'},
                {name: 'actions'}
            ],
            sortcolumn: 'property_number',
            sortdirection: 'asc',
            cache: false,
            url: path,
            filter: function () {
    ...
    $(document).ready(function () {
        ...
        $("#" + gridID).jqxGrid({
            ...
            columns: [
                {text: 'Property Number', datafield: 'property_number', filtertype: 'textbox', filtercondition: 'contains', cellsalign: 'center', width: 150},
                {text: 'Property Size', datafield: 'property_size', cellsalign: 'center',filtertype: 'textbox', filtercondition: 'contains'},
                {text: 'Property Per Marla', datafield: 'property_per_marla',cellsalign: 'center', filtertype: 'textbox', filtercondition: 'contains'},
                {text: 'Total Price', datafield: 'property_total_price',cellsalign: 'right',  filtertype: 'textbox', filtercondition: 'contains'},
                {text: 'Date Created', datafield: 'property_date_created',cellsalign: 'center',  filtertype: 'textbox', filtercondition: 'contains'},
                {text: 'Status', datafield: 'property_status', filtertype: 'textbox', cellsalign: 'center',filtercondition: 'contains',width: 100},
